...
10c. `10c_optimized_flatgeobuf_via_geopackage.md`: implement optimized indexed FlatGeobuf generation through persistent GeoPackage staging.
...
| 10b | Bounded-memory large-archive pipeline and GeoParquet optimization | 10c-14 |
